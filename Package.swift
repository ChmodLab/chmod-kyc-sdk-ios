...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "ChmodKycKit",
            url: "https://github.com/ChmodLab/chmod-kyc-sdk-ios/releases/download/0.0.28/ChmodKycKit.xcframework.zip",
            checksum: "9f056d38ebd049cd510df7a2e6b38a4f5c6f7d7b1ba9c63111d65768ad715a24"
        ),
        .binaryTarget(
