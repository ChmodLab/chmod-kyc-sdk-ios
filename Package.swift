...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "ChmodKycKit",
            url: "https://github.com/ChmodLab/chmod-kyc-sdk-ios/releases/download/0.0.37/ChmodKycKit.xcframework.zip",
            checksum: "182dcc67ea618b1cb86cca73419a3a95dda2433815bda83cc8e95fa63243a1f6"
        ),
        .binaryTarget(
