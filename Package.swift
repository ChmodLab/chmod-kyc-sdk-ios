...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "ChmodKycKit",
            url: "https://github.com/ChmodLab/chmod-kyc-sdk-ios/releases/download/0.0.34/ChmodKycKit.xcframework.zip",
            checksum: "2bb9ed93dfedcbca8e595f5c0f394c11625ecf855af487e6d3d71e050e2e827b"
        ),
        .binaryTarget(
