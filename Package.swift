...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "ChmodKycKit",
            url: "https://github.com/ChmodLab/chmod-kyc-sdk-ios/releases/download/0.0.35/ChmodKycKit.xcframework.zip",
            checksum: "5c2847be50152beacd63dfef9425eef5d6a0bd73efe90f812c11abe3fe811a1a"
        ),
        .binaryTarget(
