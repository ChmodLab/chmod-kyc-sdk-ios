...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "ChmodKycKit",
            url: "https://github.com/ChmodLab/chmod-kyc-sdk-ios/releases/download/0.0.29/ChmodKycKit.xcframework.zip",
            checksum: "a7c145c8f27835ea6943904a33231ca0738578c8f0b6a630b9fde66da5dbbf84"
        ),
        .binaryTarget(
